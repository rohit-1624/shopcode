# shopcode (or e-commerce website)
...
## Features
- **User Authentication** - Required to Login or signup to use the features like add-to-cart,nremove-from-cart, buy-now, and user details functionality.
